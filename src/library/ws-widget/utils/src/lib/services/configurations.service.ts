...
if (!configuration && Boolean(buildConfig.SITEPATH)) {
  // locationHost = environment.sitePath
  instanceConfigPath = buildConfig.SITEPATH
}
@Injectable({
  providedIn: 'root',
})
export class ConfigurationsService {
  public _showshrink = new BehaviorSubject<any>(undefined)
  showshrink$ = this._showshrink.asObservable()
