...
export class RouterLinks {
    ...
    public static readonly PUBLIC_TOC_OVERVIEW = '/public/toc/overview';
    public static readonly PUBLIC_TNC = 'public/tnc';
    public static readonly PRIVATE_HOME = 'page/home';
    public static readonly CREATE_ACCOUNT = 'app/create-account';
    public static readonly APP_LOGIN = 'app/login';
    public static readonly FORGOT_PASSWORD = 'public/forgot-password';
    public static readonly TOC_PAGE = 'app/toc';
    public static readonly VIEWER='viewer';
    public static readonly SEARCH_PAGE='app/search';
    public static readonly NEW_TNC='app/new-tnc';
    public static readonly HOW_IT_WORKS='how-it-works';
    public static readonly PROFILE_DASHBOARD = 'profile-dashboard';
    public static readonly COMPETENCY_DASHBOARD = 'app/user/competency';
    public static readonly SELF_ASSESSMENT = 'app/user/self-assessment';
    public static readonly ABOUT_YOU = 'app/about-you';
    public static readonly GET_HELP = 'app/get-help';
    public static readonly learning = 'learning';
    public static readonly ORG_DETAILS = 'app/org-details';
    public static readonly MY_COURSES = 'my-courses';
    public static readonly REFERENCE_PLAYER = 'app/reference';
    public static readonly LEARNER_OBSERVATION = 'app/learnere-observation';
    public static readonly MENTEES_LIST = 'mentees-list';
    public static readonly OBSERVATION_TRACK = 'observation-track';
    public static readonly OBSERVATION_ASSESSMENT = 'observation-assessment';
    public static readonly OBSERVATION_RESULTS = 'observation-result';
    public static readonly MENTEE_PROGRESS = 'mentees-progress';
    public static readonly MENTOR = 'mentor';
    public static readonly VERIFY_MENTEE = 'verify-Mentee';
    public static readonly SCHEDULE = 'schedule';
    public static readonly VIEW_ATTEMPS = 'attemps-list';
    public static readonly OBSERVATION_REPORT = 'observation-report';
    ...
    public static readonly PROFILE_VIEW = 'app/profile-view';
