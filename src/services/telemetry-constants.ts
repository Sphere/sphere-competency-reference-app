import { Rollup ,CorrelationData, TelemetryObject} from "@project-sunbird/sunbird-sdk";
...
export enum ImpressionType {
    ...
    SIGNIN_POPUP_LOADED = 'signin-popup-loaded',
}
...
export enum InteractSubtype {
    ...
    APPLE = 'apple',
    STATE = 'state',
    OTP_LOGIN_SELECTED = 'otp-login-selected',
    PASSWORD_LOGIN_SELECTED = 'password-login-selected',
    CREATE_ACCOUNT_CLICKED = 'create-account-clicked',
    COURSE_CLICKED = 'course-clicked',
    YOUTUBE_CONTENT_CLICKED = 'youtube-content-clicked',
    COURSE_DETAILS_CLICKED = 'course-details-clicked',
    START_OVER_CLICKED = 'start-over-clicked',
    ANSWER_CLICKED = 'answer-clicked',
    NEXT_QUESTION_CLICKED = 'next-question-clicked',
    PREVIOUS_QUESTION_CLICKED = 'previous-question-clicked',
