...
export class WidgetContentShareService {
  ...
  private shareContentApi(req: NsShare.IEmailRequest): Observable<NsShare.IEmailResponse> {
    return this.http.post<NsShare.IEmailResponse>(API_PROTECTED_END_POINTS.USER_SHARE, req)
  }
  shareContent(
  ...
  contentShareNew(req: NsShare.IShareRequest) {
    return this.http.post(API_PROTECTED_END_POINTS.USER_CONTENT_SHARE, req)
  }
}
