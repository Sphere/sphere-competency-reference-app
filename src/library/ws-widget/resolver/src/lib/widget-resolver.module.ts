...
export class WidgetResolverModule {
  static forRoot(config: NsWidgetResolver.IRegistrationConfig[]): ModuleWithProviders<any> {
    return {
  ...
  static forChild(config: NsWidgetResolver.IRegistrationConfig[]): ModuleWithProviders<any> {
    return {
      ngModule: WidgetResolverModule,
      providers: [
        WidgetResolverService, LoginResolverService,
