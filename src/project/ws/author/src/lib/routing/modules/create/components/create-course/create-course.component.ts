...
export class CreateCourseComponent implements OnInit {
  ...
  constructor(private fb: UntypedFormBuilder, private snackBar: MatSnackBar, private svc: CreateService,
              private router: Router,
              private loaderService: LoaderService, private dialog: MatDialog,
              private authInitService: AuthInitService,
              private accessControlSvc: AccessControlService) { }
  createCourseForm: UntypedFormGroup | undefined
  ngOnInit() {
    this.createCourseForm = this.fb.group({
      courseName: new UntypedFormControl('', [Validators.required]),
      courseIntroduction: new UntypedFormControl('', [Validators.required]),
    })
