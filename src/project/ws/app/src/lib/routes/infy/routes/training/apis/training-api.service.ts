    ...
    try {
      ...
      if (dateObj.location) {
        if (dateObj.search) {
          ...
          url = `${this.PROXIES_SLAG_V8}/LA/coschedules/apis/public/v8/mobileApp/kong/CourseOfferingSchedules?aggsSize=1000&endDate=${endDate}&startDate=${startDate}&from=0&refinementfilter='location':'${location}'&searchquery=${search}`
        } else {
          // tslint:disable-next-line:max-line-length
          url = `${this.PROXIES_SLAG_V8}/LA/coschedules/apis/public/v8/mobileApp/kong/CourseOfferingSchedules?aggsSize=1000&endDate=${endDate}&startDate=${startDate}&from=0&refinementfilter='location':'${location}'`
        }
      } else {
        if (dateObj.search) {
          // tslint:disable-next-line:max-line-length
          url = `${this.PROXIES_SLAG_V8}/LA/coschedules/apis/public/v8/mobileApp/kong/CourseOfferingSchedules?aggsSize=1000&endDate=${endDate}&startDate=${startDate}&from=0&searchquery=${search}`
        } else {
          // tslint:disable-next-line:max-line-length
          url = `${this.PROXIES_SLAG_V8}/LA/coschedules/apis/public/v8/mobileApp/kong/CourseOfferingSchedules?aggsSize=1000&endDate=${endDate}&startDate=${startDate}&from=0`
        }
      }
