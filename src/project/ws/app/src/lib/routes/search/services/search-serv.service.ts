...
export class SearchServService {
  ...
  async getSearchConfig(): Promise<any> {
    ...
    this.searchConfig = this.fetchSearchConfig()
    // }
  ...
  async getApplyPhraseSearch(): Promise<boolean> {
    ...
    // const config = await this.fetchSearchConfig()
  ...
  getLearning(request: ISearchRequestV3): Observable<NSSearch.ISearchV6ApiResultV2> {
    return this.searchV6WrapperRecommendation(request)
  }

  searchV6Wrapper(request: any, getCourses = ''): Observable<NSSearch.ISearchV6ApiResultV2> {
    ...
    const v6Request: NSSearch.ISearchV6RequestV2 = {
      request: {
        ...
        filters: request.request.query ? { 
          ['contentType']: ['Course'], 
          ['status']: ['Live'],
          ['lang']: _.get(request, 'request.filters.lang')
        } : request.request.filters,
        sort_by: {
          lastUpdatedOn: request.request.sort_by.lastUpdatedOn,
        },
        facets: Object.keys(_.get(this.searchConfig, 'search.visibleFilters', searchData.search.visibleFilters)),
        fields: request.request.fields,
      },
    }
    return this.searchApi.getSearchV6Results(v6Request, _.get(this.searchConfig, 'defaultsearch', searchData.defaultsearch), getCourses)
  }

  searchV6WrapperRecommendation(request: any): Observable<NSSearch.ISearchV6ApiResultV2> {
    const v6Request: any = {
      query: request.query,
    ...
    return this.searchApi.getSearchRecomended(v6Request)
  }
