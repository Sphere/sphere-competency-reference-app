...
import { NsAppsConfig } from '../../../../../../library/ws-widget/utils/src/lib/services/configurations.model'
...
export class BtnProfileComponent extends WidgetBaseComponent
  ...
  openProfilePage() {
    // this.cordovaHttpService.checkTokenValidation().subscribe((session) => {
    //   const browser: any = this.iab.create('https://'+environment.sitePath+'/openid/sphereapp?x-authenticated-user-token=' + session.access_token + '&viewlayer=uptsu', '_self',
    //     {
    //       hideurlbar: 'yes',
    ...
    //   browser.show();
    // })
    this.router.navigate([RouterLinks.PROFILE_DASHBOARD])
  }
}
