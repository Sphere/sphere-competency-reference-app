...
import { SubapplicationRespondService } from '../../../../../../../library/ws-widget/utils/src/lib/services/subapplication-respond.service'
  ...
  ngOnInit() {
    ...
    if (
      ...
      if(!navigator.onLine){
        ...
        this.contentService.getContentDetails(option).toPromise().then(async (data: any) => {
          let content = this.updateDataRecursively(data);
          console.log('content data of scrom  ', content);
